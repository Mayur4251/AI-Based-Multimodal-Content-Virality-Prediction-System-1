      ...
      <div className="rounded-2xl bg-zinc-900/90 border border-zinc-800 p-6 space-y-4">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-zinc-400 mt-0.5">
              Model validation reference curve
            </p>
          </div>
        ...
        <div className="h-52 w-full bg-zinc-950/80 rounded-xl border border-zinc-800/80 p-4 relative flex flex-col justify-between">
          <svg
          ...
          >
            ...
            <path
              d="M 0 150 C 15 30, 45 10, 300 0"
              fill="none"
              stroke="#c084fc"
              strokeWidth="3"
            />

            <circle cx="0" cy="150" r="3" fill="#ffffff" />
            <circle cx="20" cy="100" r="3" fill="#ffffff" />
            <circle cx="45" cy="50" r="3" fill="#ffffff" />
            <circle cx="90" cy="25" r="3" fill="#ffffff" />
            <circle cx="150" cy="12" r="3" fill="#ffffff" />
            <circle cx="225" cy="5" r="3" fill="#ffffff" />
            <circle cx="300" cy="0" r="3" fill="#ffffff" />
          </svg>
      ...
      <div className="rounded-2xl bg-zinc-900/90 border border-zinc-800 p-6 space-y-5">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-zinc-400 mt-0.5">
              Model architecture reference metrics
            </p>
          </div>
            ...
            <tbody className="divide-y divide-zinc-800/60 font-mono text-zinc-300">
              ...
              <tr>
                <td className="py-3.5 font-bold text-white font-sans flex items-center gap-2">
                  ...
                  Multimodal Fusion Network (ViralAI)
                </td>
                ...
                <td className="py-3.5">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="w-16 bg-zinc-800 h-1.5 rounded-full overflow-hidden">
                      <div className="bg-purple-500 h-full w-[94.2%]" />
                    </div>
                  </div>
                </td>

                <td className="py-3.5">92.8%</td>
                <td className="py-3.5">93.5%</td>
              ...
              <tr>
                <td className="py-3.5 font-semibold text-zinc-300 font-sans">
                  XGBoost Metaclassifier
                </td>
                ...
                <td className="py-3.5">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="w-16 bg-zinc-800 h-1.5 rounded-full overflow-hidden">
                      <div className="bg-blue-500 h-full w-[86.4%]" />
                    </div>
                  </div>
                </td>

                <td className="py-3.5">85.1%</td>
                <td className="py-3.5">84.7%</td>
                <td className="py-3.5">84.9%</td>
              </tr>
              ...
              <tr>
                ...
                <td className="py-3.5">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="w-16 bg-zinc-800 h-1.5 rounded-full overflow-hidden">
                      <div className="bg-amber-500 h-full w-[79.1%]" />
                    </div>
                  </div>
                </td>

                <td className="py-3.5">77.8%</td>
                <td className="py-3.5">80.3%</td>
                <td className="py-3.5">79.0%</td>
              </tr>
              ...
              <tr>
                ...
                <td className="py-3.5">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="w-16 bg-zinc-800 h-1.5 rounded-full overflow-hidden">
                      <div className="bg-zinc-600 h-full w-[72.5%]" />
                    </div>
                  </div>
                </td>

                <td className="py-3.5">73.1%</td>
                <td className="py-3.5">71.8%</td>
                <td className="py-3.5">72.4%</td>
              </tr>
            </tbody>
          </table>
        </div>
